...
from day01.snake import DARKRED
...
title_rect.center = (WINDOW_WIDTH//2, WINDOW_HEIGHT//2) # places the box containing the text object

score_text = font.render("Score: 0", True, GREEN, DARKRED)
score_rect = score_text.get_rect()
score_rect.center = (WINDOW_WIDTH//2, WINDOW_HEIGHT//2)

game_over_text = font.render("Game Over", True, DARKGREEN, DARKRED)
...
while running:
    ...
    head_x += snake_dx
    head_y += snake_dy
    body_coord = (head_x, head_y, SNAKE_SIZE, SNAKE_SIZE)
    # Check for game over
